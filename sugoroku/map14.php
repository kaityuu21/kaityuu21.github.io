...
<body>
 ...
 echo '2の目が出た！';
  ...
  echo '3の目が出た！';
      ...
      <div class="images">
        <p><img class="wow zoomIn" src="images/9.png"> </p>
        <p><img class="wow shake" data-wow-duration="3s" data-wow-iteration="100" src="images/edamanekun.png">
          <img class="wow rubberBand" data-wow-duration="3s" data-wow-iteration="100" src="images/birdkun.png"> </p>
      </div>
      ...
      <form action="map15.php" method="post">
